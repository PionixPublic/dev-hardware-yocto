...
SUMMARY = "EVerest image for PIONIX Micro Megawat Charger"
...
set_custom_hostname_charger() {
    echo "umwcharger" > ${IMAGE_ROOTFS}/etc/hostname
}

# Add the function to the post-processing commands
ROOTFS_POSTPROCESS_COMMAND += "set_custom_hostname_charger; "
